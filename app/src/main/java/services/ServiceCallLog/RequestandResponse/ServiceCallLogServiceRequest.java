...
public class ServiceCallLogServiceRequest implements Serializable {
    ...
    // Login Credentials
    public ServiceCallLogServiceRequest.Login Login;
    ...
    public ServiceCallLogServiceRequest.Login getLogin() {
        return Login;
    }

    public void setLogin(ServiceCallLogServiceRequest.Login login) {
        Login = login;
    }
