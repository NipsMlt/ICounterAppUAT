...
public class ExceptionLogRequestDetails implements Serializable {
    ...
    // Login Credentials
    public ExceptionLogRequestDetails.Login Login;
    ...
    public ExceptionLogRequestDetails.Login getLogin() {
        return Login;
    }

    public void setLogin(ExceptionLogRequestDetails.Login login) {
        Login = login;
    }
