...
public class KioskPaymentResponseItem implements Serializable {
    ...
    public KioskPaymentResponseItem.ServiceAttributesList getServiceAttributesList() {
        return ServiceAttributesList;
    }

    public void setServiceAttributesList(KioskPaymentResponseItem.ServiceAttributesList serviceAttributesList) {
        ServiceAttributesList = serviceAttributesList;
    }

    public ServiceAttributesList ServiceAttributesList;
    public KskOperationTypeArray OperationType;
    ...
    public KskOperationTypeArray getOperationType() {
        return OperationType;
    }

    public void setOperationType(KskOperationTypeArray operationType) {
