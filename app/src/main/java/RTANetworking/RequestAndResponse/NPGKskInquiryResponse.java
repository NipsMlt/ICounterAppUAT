...
public class NPGKskInquiryResponse implements Serializable{
    ...
    public NPGKskInquiryResponse.ServiceType getServiceType() {
        return ServiceType;
    }

    public void setServiceType(NPGKskInquiryResponse.ServiceType serviceType) {
        ServiceType = serviceType;
    }

    public NPGKskInquiryResponse.ServiceAttributesList getServiceAttributesList() {
        return ServiceAttributesList;
    }

    public void setServiceAttributesList(NPGKskInquiryResponse.ServiceAttributesList serviceAttributesList) {
        ServiceAttributesList = serviceAttributesList;
    }

    public NPGKskInquiryResponse.CustomerUniqueNo getCustomerUniqueNo() {
        return CustomerUniqueNo;
    }

    public void setCustomerUniqueNo(NPGKskInquiryResponse.CustomerUniqueNo customerUniqueNo) {
