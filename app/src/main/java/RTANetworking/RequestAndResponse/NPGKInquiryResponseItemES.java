...
public class NPGKInquiryResponseItemES implements Serializable {
    ...
    public class CustomerUniqueNo implements Serializable {
        ...
        @Expose
        private List<CKeyValuePair> cKeyValuePair = null;

        public List<CKeyValuePair> getCKeyValuePair() {
            return cKeyValuePair;
        }

        public void setCKeyValuePair(List<CKeyValuePair> cKeyValuePair) {
    ...
    public class ServiceTypeES implements Serializable {
        ...
        @Expose
        private KskServiceItem items = null;
