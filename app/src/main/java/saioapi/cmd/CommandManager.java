...
/**
 * This class defines the Command Controller APIs to be used by the applications.Please Reference "VNG Saturn Command Reference Manual" document.
 */
public class CommandManager {
    ...
    * @return Return zero if the function succeeds else nonzero error code defined in class constants.Please refer to Com.close().
    ...
    /**
    * This method gets a value indicating the open or closed status of XAC VNG platform device. The method tracks whether the device is open for use by the Cmd API, not whether the device is open by any application.
