...
public class MsgBase {
    ...
    /**
     *  Indicates the CommPort service request.
     *  <p>
    ...
    public static final String getErrorDescription(int err) {
        ...
        switch (err) {
            ...
            case ERR_FILE_NOT_EXIST:
                ...
                break;
            case ERR_NOT_READY:
                description = "Firmware is busy or in using.";
                break;
            case ERR_FW_TAMPER:
            ...
            case ERR_BUSY_EPP_VERSION:
                description = "Service is busy (Get CommPort Version).";
                break;
            case ERR_BUSY_EPP_MODULE:
                description = "Service is busy (Get CommPort Module Info).";
                break;
            case ERR_BUSY_EPP_KCV:
                description = "Service is busy (Get CommPort KCV).";
                break;
            case ERR_BUSY_EPP_UPDATING:
                description = "Service is busy (Updating CommPort Firmware).";
                break;
            ...
            case ERR_BUSY_OS_UPDATING:
                description = "Service is busy (Updating OS Graphic).";
                break;
